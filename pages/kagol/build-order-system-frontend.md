...
<!--
TinyPro 实现了在线方式创建国际化词条、菜单、路由等，可以让前端工程师专注于开发页面，不需要再去做配置菜单、路由、国际化词条等繁琐的工作。

可以说解放了前端工程师，又方便了管理员对业务系统进行控制，因为管理员不配置菜单，即使前端把页面搭建出来，系统上也不会显示出来。
...
<!--
菜单配置好就可以开发页面了，和后端开发一样，先规划下目录结构...
-->
